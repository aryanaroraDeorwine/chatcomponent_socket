...
class MultiImagesViews extends StatelessWidget {
  ...
  final bool isSeen;
  final String time;
  const MultiImagesViews({super.key, required this.multiImageList, required this.index, required this.reaction, required this.isSender, required this.onTap, required this.onLongPress, required this.chatController, required this.isSeen, required this.time});
